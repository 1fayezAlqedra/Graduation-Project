...
@section('content')
    ...
    <div class="top-bar">
        ...
        <button class="btn btn-primary" onclick="window.location.href='{{ route('tasks.create') }}'">
        ...
        <div class="day-section">
            ...
            <div class="task-card">
                ...
                <div class="task-actions">
                    <button title="Edit" onclick="window.location.href='edit-task.html'"><i class="fas fa-edit"></i></button>
